...
@RestController
@RequestMapping(value = {"/books"}, params = {"version=2"})
public class BookRequestParamController {
    ...
    List<Book> bookList = new ArrayList<>(Arrays.asList(
            ...
            new Book(5, "Book E", "5555-5555", 500),
            new Book(6, "Book F", "6666-6666", 600),
            new Book(7, "Book G", "7777-7777", 700)
    ));
